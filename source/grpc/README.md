...
A gRPC source server should implement the [`Source`](https://github.com/balachandar-git/jet-config/blob/master/source/grpc/proto/grpc.proto#L3L6) proto interface.
